...
execute if entity @p[scores={teleport_home=1..}] as @p[scores={teleport_home=1..}] positioned 0 10 0 if entity @e[tag=teleport_home,distance=2..,type=item] run tp @s @e[tag=teleport_home,type=item,limit=1]
execute if entity @p[scores={teleport_home=1..}] as @p[scores={teleport_home=1..}] positioned 0 10 0 if entity @e[tag=teleport_home,distance=2..,type=item] run kill @e[tag=teleport_home,type=item,distance=2..]
execute if entity @p[scores={teleport_home=1..}] as @p[scores={teleport_home=1..}] positioned 0 10 0 unless entity @e[tag=teleport_home,type=item,distance=..2] run setblock ~ ~ ~ air
execute if entity @p[scores={teleport_home=1..}] as @p[scores={teleport_home=1..}] positioned 0 10 0 unless entity @e[tag=teleport_home,type=item,distance=..2] run scoreboard players reset @s teleport_home
execute if entity @p[scores={teleport_home=1..}] as @p[scores={teleport_home=1..}] positioned 0 10 0 unless entity @e[tag=teleport_home,type=item,distance=..2] run tag @s remove teleport_home_trigger_enabled
