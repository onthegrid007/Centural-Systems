...
execute if entity @p[scores={teleport_home=1..}] as @p[scores={teleport_home=1..}] positioned 0 10 0 unless entity @e[tag=teleport_home,type=item,distance=..2] run summon item ~ ~1 ~ {Tags:["teleport_home"]}
