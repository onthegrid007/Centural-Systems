...
#triggers
execute as @s[scores={teleport_home=1}] run function home_handler:triggers/teleport_home
...
execute as @s[scores={set_home=1}] run function home_handler:triggers/set_home
execute as @s[scores={delete_home=1}] run function home_handler:triggers/delete_home
