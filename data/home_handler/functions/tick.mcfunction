...
execute if @p[tag=home_trigger_enabled] as @a[tag=home_trigger_enabled] unless entity @s[scores={home_state=0}] run scoreboard players enable @s set_home
execute if @p[tag=home_trigger_enabled] as @a[tag=home_trigger_enabled] unless entity @s[scores={home_state=0}] run scoreboard players enable @s get_home
execute if @p[tag=home_trigger_enabled] as @a[tag=home_trigger_enabled] unless entity @s[scores={home_state=0}] run scoreboard players enable @s teleport_home
