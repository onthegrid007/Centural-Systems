execute as @a unless entity @s[scores={home_state=..2147483647}] run tag @s add home_trigger_cooldown
...
execute if entity @p[tag=home_trigger_cooldown,scores={home_state=0,home_cooldown=100}] as @a[tag=home_trigger_cooldown,scores={home_state=0,home_cooldown=100}] run tag @s remove home_trigger_cooldown
