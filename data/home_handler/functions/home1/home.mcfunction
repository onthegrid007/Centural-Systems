...
execute positioned 0 2 0 at @e[nbt={Item:{tag:{home_state:0L}}},limit=1,distance=2..] run tp @s[tag=homeRun,limit=1] ~ ~ ~
...
execute at @e[nbt={Item:{tag:{home_state:0L}}},limit=1] as @s[distance=..2] run tag @s remove homeRunat
