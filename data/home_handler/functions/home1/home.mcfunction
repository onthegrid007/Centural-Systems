...
execute positioned 0 2 0 as @e[nbt={Item:{tag:{home_state:0L}}},limit=1,distance=2..] run tp @a[tag=homeRun,limit=1] @s
...
execute positioned 0 2 0 if entity @e[nbt={Item:{tag:{home_state:0L}}},limit=1,distance=2..] run tag @s remove homeRun
