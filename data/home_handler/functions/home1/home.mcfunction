...
summon item 0 2 0 {Age:5960,PickupDelay:-1,Item:{id:"minecraft:paper",Count:1b,tag:{home_state:0L}}}
...
tp @a[tag=homeRun,limit=1] @e[nbt={Item:{tag:{homeState:0L}}},limit=1]
