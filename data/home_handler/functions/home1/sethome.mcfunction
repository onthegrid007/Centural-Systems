...
execute as @s[tag=sethomeRun] store result score @s home_x run scoreboard players get @s position_x
execute as @s[tag=sethomeRun] store result score @s home_y run scoreboard players get @s position_y
execute as @s[tag=sethomeRun] store result score @s home_z run scoreboard players get @s position_z
