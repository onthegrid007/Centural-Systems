execute if entity @p[scores={detection_time=50..}] as @a[scores={detection_time=50..}] run scoreboard players reset @s clip_detection
execute if entity @p[scores={detection_time=50..}] as @a[scores={detection_time=50..}] run scoreboard players reset @s detection_time
