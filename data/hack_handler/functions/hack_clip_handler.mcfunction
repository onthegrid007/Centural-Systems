...
execute if entity @p[gamemode=!spectator] as @a[gamemode=!spectator] at @s if block ~ ~ ~ grass_block if block ~ ~1 ~ grass_block run scoreboard players add @s clip_detection 1
