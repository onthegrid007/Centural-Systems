...
execute if entity @p[gamemode=!spectator] as @a[gamemode=!spectator] at @s unless block ~ ~ ~ air unless block ~ ~1 ~ air unless block ~ ~ ~ portal unless block ~ ~1 ~ portal run scoreboard players add @s clip_detection 1
