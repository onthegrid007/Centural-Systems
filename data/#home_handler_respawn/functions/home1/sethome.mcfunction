...
execute as @s[tag=sethomeRun] store result score @s home1_x run scoreboard players get @s position_x
execute as @s[tag=sethomeRun] store result score @s home1_y run scoreboard players get @s position_y
execute as @s[tag=sethomeRun] store result score @s home1_z run scoreboard players get @s position_z
