...
execute as @a[tag=warp_cooldown,scores={warp_to_spawn=-2147483648..2147483647}] run scoreboard players reset @s warp_to_spawn
execute as @a[tag=!warp_cooldown,scores={warp_to_wild=-2147483648..2147483647}] run tag @s add warp_cooldown
execute as @a[tag=warp_cooldown,scores={warp_to_wild=-2147483648..2147483647}] run scoreboard players reset @s warp_to_wild
