...
#scoreboard objectives add home1_x dummy "Home 1 X-Coordinate"
#scoreboard objectives add home1_y dummy "Home 1 Y-Coordinate"
#scoreboard objectives add home1_z dummy "Home 1 Z-Coordinate"
