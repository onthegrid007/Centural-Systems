...
execute as @e[scores={one_time_math=0},limit=1] run function tphandler:sendrequest
execute unless entity @e[scores={one_time_math=0},limit=1] as @e[nbt={Item:{tag:{tpState:0L}}},limit=1] run function tphandler:playerdoesnotexist
